...
(function (global) {
  ...
  const Settings = {
    ...
    load: function (email) {
      ...
      return clampProviders(Object.assign({}, DEFAULTS, saved));
    },

    save: function (email, settings) {
      settings = clampProviders(Object.assign({}, DEFAULTS, settings || {}));
    ...
    syncFromServer: async function (email) {
      ...
      var merged = clampProviders(Object.assign({}, DEFAULTS, remote));
